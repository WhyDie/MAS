...
export function GuidePage() {
  ...
  return (
    <div className="animate-fade-in-up">
        ...
        <div className="flex justify-between items-start flex-wrap gap-4">
          <div>
            <h1 className="text-3xl font-heading font-bold mb-3" style={{ color: 'var(--text-primary)', fontSize: '32px', lineHeight: '1.2', letterSpacing: '1px' }}>
              🌐 Путівник по військових ресурсах
            </h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '16px', lineHeight: '1.6' }}>
              Корисні сайти, сервіси та ресурси для військовослужбовців ЗСУ
            </p>
          </div>
          {canManage && (
      ...
      {/* Search */}
      <div className="p-4 rounded-2xl mb-6 animate-fade-in-up" style={{ background: 'var(--bg-glass)', backdropFilter: 'blur(12px)', border: '1px solid var(--border-subtle)', animationDelay: '0.1s', animationFillMode: 'both' }}>
        <input
          type="text"
          value={searchQuery}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredResources.map((resource, index) => (
            <a
              ...
              className="military-card p-6 group animate-fade-in-up"
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center text-2xl flex-shrink-0" style={{ background: 'var(--bg-glass)', border: '1px solid var(--border-subtle)' }}>
                  {resource.icon || '🌐'}
                </div>
